				...
				<div id="appFrame" class="row ">
					...
					<div  class="col-lg-12 col-md-12 col-sm-12" id="app-index">
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<!-- <button type="button" id="roomViewButton" class="btn btn-info btn-sm" data-toggle="modal" data-target="#roomView">Room View</button> -->
							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body row">
							        <div class="col-lg-12 col-md-12 col-sm-12" id="wall">
							        	...
							        	<canvas id="roomViewCanvas"></canvas>
							        </div>
							...
							<!-- <div class="container"> -->
								...
								<div class="tab-container">
									<div id="index-frames" class='tab-pane active'></div>
									<div id="index-mats" class='tab-pane'>
										<div class = "col-lg-4 col-md-4 col-sm-2">
											<form class="form-inline" style='padding-top:15px'>
												<div class="form-group">
												  <label for="mats-width">Mats Width:</label>
												  <select class="form-control" id="mats-width">
									...
									<div id="index-color" class='tab-pane'>
