            	...
            	<div class="row">
	                ...
	                <div class="main-container">
	                    ...
	                    <div class="span-14 column last">
			                <div style="background-color: #fff;" id="body">
			                            ...
			                            <tr>
			                                <td valign="top">
			                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			                                                ...
			                                                <table border="0" cellspacing="0" cellpadding="0">
			                                                    ...
			                                                    <tr>
			                                                        <td colspan="2" align="center">
			                                                            <div id="framing-image" style="display:block; margin-top: 0;" class="dropshadow">
			                                                                <div id="frame">
			                                                                    <div id="slip">
			                                                                        <div id="mat1">
			                                                                            <div id="mat2">
			                                        ...
			                                        <tr id="size-notice" style="display:none">
			                                            <td align="center" id="prodinfo" class="info">&nbsp;<a href="/images/Rebate.jpg"
			                                                                                                   class="zoom">
			                                                                                            ...
			                                                                                            <td width="54%" class="highlight">
			                                                                                                <a href="javascript: void(true);"
			                                                                                                   id="add2cart" class="highlight">
			                                                                                                    <img
			                                                                                                            src="{{ URL::asset('web/photo_frame/plain_mirror/static/images/cart-icon.gif') }}"
			            ...
			            <div class="span-10 column last" style="float:right;background-color: #fff;">
                    ...
                    <div id="tabs">
                        ...
                        <div id="frames">
                            <p>
                                ...
                                <select style="display:none;" class="info" name="iframe_cat_id" id="iframe_cat_id" onchange="selectframelist(event, 1)">
                                    <!-- <option value="all" > --></option>
                                    <option value="50" data-url="file:///D:/xampp_5.6/htdocs/otw/app/modules/web/Views/photo_frame/plain_mirror/1-stains-frames.blade.php">1-Stains</option>
