<div class="frame" data-filtr="rate-1 code-220A" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1227.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1227.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1227.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
...
<div class="frame" data-filtr="rate-2 code-249L" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_928.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_928.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_928.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-3 code-220D" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1228.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_178.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1228.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-4 code-220T" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1300.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1300.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1300.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-5 code-222A" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_743.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_743.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_743.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-6 code-110BV" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1090.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1090.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1090.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-7 code-110LV" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1089.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1089.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1089.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-8 code-110TV" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1092.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1092.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1092.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-10 code-110CH" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1150.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1150.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1150.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-1 code-412RT" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_1314.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_1314.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_1314.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>
<div class="frame" data-filtr="rate-2 code-136B" style="text-align: left; margin-bottom: 10px;border-bottom:1px dotted #ccc; min-height: 155px;">
    ...
    <div class="col">
        <strong>
            <a href="javascript: $('#size-notice').show();void(true);" class="selectframe" >
                <img data-src-top="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/top_frame/top_frame_178.jpg') }}" border="0" alt="" src="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/thumb/th_cross_frame_178.jpg') }}" style="float: right; margin-right: 5px;" class="dropshadow">
            </a>
        </strong>
    </div>
    <div class="col" style="padding-left:5px">
        ...
        <strong>
            <a href="{{ URL::asset('web/photo_frame/plain_mirror/images/frame_images/large/lrg_cross_frame_178.jpg') }}" class="zoom">zoom</a>
        </strong>
    </div>
</div>
<div style="clear: both;"></div>