...
var ProductManager = function () {
        ...
        function discountCalculator(total_price, discount_percent) {
            ...
            if(typeof newDiscountedPrice === 'number') {
                ...
                discountedValRow.html("AUD " + discountprice);
            }
        ...
        var e,
            ...
            I = function () {
                ...
                $("#summary-frame").html(product.frame.frameCode),
                    ...
                    $("#summary-glass").html(product.glass.replace(e, " ").replace("glass", "")),
                    $("#summary-backing").html(product.backing.replace(e, " ").replace("glass", "")),
                    ...
                    $("#summary-frame-price").html("AUD " + product.framePrice.toFixed(2)),
                    $("#summary-slip-price").html("AUD " + product.slip.price.toFixed(2)),
                    $("#summary-fillet-price").html("AUD " + product.fillet.price.toFixed(2)),
                    $("#summary-mat-top-price").html("AUD " + product.matboards.mat1.price.toFixed(2)),
                    $("#summary-mat-bottom-price").html("AUD " + product.matboards.mat2.price.toFixed(2)),
                    $("#summary-glass-price").html("AUD " + product.glassPrice.toFixed(2)),
                    $("#summary-backing-price").html("AUD " + product.backingPrice.toFixed(2)),
                    $("#summary-printing-price").html("AUD " + product.printing.price.toFixed(2)),
                    $("#error-current-selection-size").html("AUD" + $("#summary-glass-size").html());
            },
            W = function (e, t) {
                var a = [];
