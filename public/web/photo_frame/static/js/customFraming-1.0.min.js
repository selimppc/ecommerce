...
var ProductManager = function () {
	  var e, t = ! 1,
		  ...
		  f = function () {
			...
			$.ajax({
			  type: "GET",
			  url: "web/photo_frame/static/json/price-list.json",
			  success: function (a) {
				e = a, t = ! 0, H()
			  },
		  ...
		  C = function () {
			var e, t, a, i, r = product.matboards,
				o = parseInt(document.querySelector("[name=number-of-mats]:checked")
					.value),
				n = document.querySelector("[name=matboard-width-type]:checked")
					.value;
			if (m = ! 1, u = ! 1, o > 0) {
			  if (m = ! 0, "uniform" == n) {
		  ...
		  I = function () {
			...
			var e = new RegExp("-", "g");
			$("#summary-frame")
				.html(product.frame.frameCode), $("#summary-slip")
				.html(product.slip.frame.frameCode), $("#summary-fillet")
				.html(product.fillet.frame.frameCode), $("#summary-mat-top")
				.html(product.matboards.mat1.matName), $("#summary-mat-bottom")
				.html(product.matboards.mat2.matName), $("#summary-glass")
				.html(product.glass.replace(e, " ")
					.replace("glass", "")), $("#summary-backing")
				.html(product.backing.replace(e, " ")
					.replace("glass", "")), $("#summary-image-size")
				.html(product.imageWidth + " x " + product.imageHeight + " cm"), $("#summary-glass-size")
				.html(product.innerWidth + " x " + product.innerHeight + " cm"), $("#summary-outer-size")
				.html(product.outerWidth + " x " + product.outerHeight + " cm"), $("#summary-printing")
				.html(product.printing.paper), $("#summary-frame-price")
				.html("$ " + product.framePrice.toFixed(2)), $("#summary-slip-price")
				.html("$ " + product.slip.price.toFixed(2)), $("#summary-fillet-price")
				.html("$ " + product.fillet.price.toFixed(2)), $("#summary-mat-top-price")
				.html("$ " + product.matboards.mat1.price.toFixed(2)), $("#summary-mat-bottom-price")
				.html("$ " + product.matboards.mat2.price.toFixed(2)), $("#summary-glass-price")
				.html("$ " + product.glassPrice.toFixed(2)), $("#summary-backing-price")
				.html("$ " + product.backingPrice.toFixed(2)), $("#summary-printing-price")
				.html("$ " + product.printing.price.toFixed(2)), $("#error-current-selection-size")
				.html($("#summary-glass-size")
					.html())
		  },
		  W = function (e, t) {
			var a = [];
	  ...
	  $(this)
		  ...
		  .on("click", function () {
			$(".frame-thumb-selected")
				.removeClass("frame-thumb-selected"), $(this)
				.addClass("frame-thumb-selected"), product.frame = $.extend(! 0, {}, $(this)
				.data()), handleFloatFrame(product.frame.frameCode), setFrameData($(this)
				.data()), $("#thumb-selected")
				.removeAttr("id"), $(this)
				.attr("id", "thumb-selected")
...
var elements = document.querySelector("#matboard-form")
